...
final case class DownstreamSubmittedSuccess(qtNumber: QtNumber, processingDate: Instant, formBundleNumber: String)

object DownstreamSubmittedSuccess {

  implicit val reads: Reads[DownstreamSubmittedSuccess] = (
  ...
  )(DownstreamSubmittedSuccess.apply _)
}
