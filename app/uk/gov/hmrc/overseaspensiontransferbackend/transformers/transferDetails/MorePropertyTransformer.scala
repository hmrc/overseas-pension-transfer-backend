...
class MorePropertyTransformer extends PathAwareTransformer with BooleanTransformerStep {

  override def externalPath: JsPath = JsPath \ "transferDetails" \ "moreProp"

  override def internalPath: JsPath = JsPath \ "transferDetails" \ "typeOfAssets" \ "moreProp"
