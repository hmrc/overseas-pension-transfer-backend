...
class MoreQuotedTransformer extends PathAwareTransformer with BooleanTransformerStep {

  override def externalPath: JsPath = JsPath \ "transferDetails" \ "moreQuoted"

  override def internalPath: JsPath = JsPath \ "transferDetails" \ "typeOfAssets" \ "moreQuoted"
