...
class RecordVersionTransformer extends PathAwareTransformer with JsonHelpers {

  val jsonKey                       = "recordVersion"
  override val externalPath: JsPath = JsPath \ "transferDetails" \ "typeOfAssetsVersion" \ jsonKey
  override val internalPath: JsPath = JsPath \ "transferDetails" \ "typeOfAssets" \ jsonKey
