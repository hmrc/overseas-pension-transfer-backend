...
class JsonHelpersSpec extends AnyFreeSpec with Matchers with JsonHelpers {
  ...
  private def qShare(v: Int, n: Int, c: String, cls: String): JsObject =
    Json.obj(
      "quotedValue"      -> BigDecimal(v),
      "quotedShareTotal" -> n,
      "quotedCompany"    -> c,
      "quotedClass"      -> cls
    )

  private def uShare(v: Int, n: Int, c: String, cls: String): JsObject =
    Json.obj(
      "unquotedValue"      -> BigDecimal(v),
      "unquotedShareTotal" -> n,
      "unquotedCompany"    -> c,
      "unquotedClass"      -> cls
    )
